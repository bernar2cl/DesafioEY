...
class PutUsuarioServiceTest {
    ...
    void actualizarUsuario_Success() {
        ...
        UsuarioResponseDto result = putUsuarioService.actualizarUsuario(usuario.getId(), requestDto);
    ...
    void actualizarUsuario_UsuarioNoEncontrado() {
        ...
        assertThrows(java.util.NoSuchElementException.class,
                () -> putUsuarioService.actualizarUsuario(usuario.getId(), requestDto));
    }
}